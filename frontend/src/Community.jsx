        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="relative max-w-2xl mx-auto">
              <img src="/search.svg" className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                    ...
                    <Card>
                      <CardContent className="p-6">
                        ...
                        <div className="space-y-4">
                          ...
                          <Button variant="outline" size="sm" className="w-full hover:bg-gray-200">
                            View All
                          </Button>
                        </div>
                      </CardContent>
