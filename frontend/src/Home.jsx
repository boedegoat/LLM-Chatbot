        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">
              Build the future with <span className="text-purple-600">HackChain</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 md:mb-10">
              Connect with builders, showcase your ideas, and win prizes in a decentralized ecosystem powered by web3
              technology.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-10">
            <div>
              ...
              <p className="text-muted-foreground">Discover the most exciting opportunities to build and win</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-background border-purple-100">
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  Generate innovative project ideas tailored to hackathon themes using our advanced AI assistant.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-background border-purple-100">
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  Find team members with complementary skills, collaborate on projects, and manage your team
                  efficiently.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-background border-purple-100">
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  Receive prizes directly to your team wallet and distribute funds fairly among team members.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground">Hear from builders and organizers who have used HackChain</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  "HackChain made it incredibly easy to find teammates with complementary skills. We won our first
                  hackathon and the prize distribution was seamless!"
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  "As an organizer, HackChain provided all the tools I needed to run a successful hackathon. The
                  platform attracted quality participants and projects."
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  "The AI idea generator helped our team come up with a unique concept that stood out from the
                  competition. We're now turning it into a startup!"
                </p>
              </CardContent>
            </Card>
          </div>
