  ...
  const teams = [
    {
      ...
      transactions: [
        { id: "tx1", type: "deposit", amount: 500, description: "Prize from nights hackathon", date: "2025-04-05" },
      ],
    },
  ]
        ...
        <Navbar/>
            <div className="container mx-auto py-12">
                <div className="max-w-4xl mx-auto">
                    ...
                    <p className="text-muted-foreground">Manage your team's funds and distribute prizes among team members</p>
                    </div>
                        ...
                        <CardContent>
                            ...
                            {teams.map((team) => (
                                ...
                                className={`p-3 rounded-md cursor-pointer flex items-center gap-3 ${
                                    team.id === activeTeam ? "bg-blue-50 border border-blue-200" : "hover:bg-slate-50"
                                }`}
                    ...
                    <div className="md:col-span-2">
                        ...
                        <Card>
                            ...
                            <Tabs defaultValue="overview">
                                ...
                                <TabsTrigger className="px-4 py-2 text-gray-500 hover:font-semibold hover:text-black hover:bg-white hover:rounded-md transition" value="overview">Overview</TabsTrigger>
                                <TabsTrigger className="px-4 py-2 text-gray-500 hover:font-semibold hover:text-black hover:bg-white hover:rounded-md transition" value="members">Members</TabsTrigger>
                                <TabsTrigger className="px-4 py-2 text-gray-500 hover:font-semibold hover:text-black hover:bg-white hover:rounded-md transition" value="transactions">Transactions</TabsTrigger>
                                <TabsTrigger className="px-4 py-2 text-gray-500 hover:font-semibold hover:text-black hover:bg-white hover:rounded-md transition" value="withdraw">Withdraw</TabsTrigger>
                                </TabsList>

                                <TabsContent value="overview">
                                <div className="space-y-6">
                                    <div className="p-6 bg-slate-50 rounded-md text-center">
                                    <img src="/wallet.svg" className="h-8 w-8 text-blue-600 mx-auto mb-2" />
                                    <p className="text-sm text-muted-foreground mb-1">Available Balance</p>
                                    <p className="text-3xl font-semibold">${selectedTeam.balance.toFixed(2)}</p>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div key={tx.id} className="flex justify-between items-center p-3 bg-slate-50 rounded-md">
                                            <div>
                                            <div className="flex items-center gap-2">
                                                {tx.type === "deposit" ? (
                                                <img src="/arrowupright.svg" className="h-4 w-4 text-green-600" />
                                                ) : (
                                                <img src="/arrowdownleft.svg" className="h-4 w-4 text-red-600" />
                                            ...
                                            <span
                                            className={
                                                tx.type === "deposit" ? "text-green-600 font-medium" : "text-red-600 font-medium"
                                            }
                                            >
